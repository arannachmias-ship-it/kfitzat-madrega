 ...
 *
 * `official: true` מסמן מונח שאושר במילון "בינה מלאכותי" של האקדמיה ללשון
 * העברית (תשס״ד). המילון ההוא קדם למודלי השפה, ולכן לרוב אוצר המילים הנוכחי
...
export const TERMS: Term[] = [
  // ---------- היסודות ----------
  {
    ...
    what: 'שם כולל לתוכנה שמבצעת משימות שנהג היה לחשוב שדורשות שיפוט אנושי — להבין טקסט, לזהות תמונה, להמליץ על החלטה.',
